"""
Django settings for mydjan02 project.
...
SECRET_KEY = '!e5kht6$=xgleeu@u81r0l15e)%mg@s8h1-t)$4dgcs*!k@j1u'
...
INSTALLED_APPS = [
    'django.contrib.admin',    # related with admin web
    'django.contrib.auth',
...
WSGI_APPLICATION = 'mydjan02.wsgi.application'
